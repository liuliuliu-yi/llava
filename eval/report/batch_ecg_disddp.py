...
import wfdb
import numpy as np
from conversation_disddp import conv_vicuna_v1, PromptMode
import os
...
def build_prompt_with_ecg(user_instruction, ecg_path, image_process_mode="Default"):
...
def main():
    ...
    parser.add_argument("--output", type=str, default='/data_C/sdb1/lyi/ecg-chat/ECG-Chat-master/llava/llava/eval/report/batch_result_disddp.json', help="输出JSON路径")
    ...
    with open(args.output, "a", encoding="utf-8") as f:
        for idx, ecg_path in enumerate(ecg_list):
            ...
            try:
                ...
                #     device=args.device
                # )
                prompt = build_prompt_with_ecg(args.instruction, ecg_path)
