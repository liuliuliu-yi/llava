...
def main():
    ...
    parser.add_argument("--instruction", type=str,help="用户问题指令",default='You are a professional medical assistant.Can you see my offered ecg signal?And help me diagnose.')
    ...
    prompt = build_prompt_with_ecg(args.instruction, args.ecg)
